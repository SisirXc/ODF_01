                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><i class="fa fa-flag-o red"></i><strong>Forum Category</strong></h2>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-8 offset-4">
                                        <div class="card">
                                            <div class="bg-image hover-overlay ripple" data-md-ripple-color="light">
                                        ...
                                        <img src="{{ asset('storage/images/categories/' . $category->image) }}"
                                            height="100" width="100" alt="Category Image">
